...
class TargetManager:
    async def create_target(self, target_name: str, file_number: str, target_number: str | None,
                            folder: str | None, offence_id: int, operator_id: int, type: str,
                            origin: str | None, target_date: str, metadata: dict, 
                            flagged: bool = False, threat_level: str | None = None):
            ...
            query = """
                ...
                RETURNING *
            """
            result = await db.fetchrow(query, target_name, file_number, target_number, folder, offence_id,
                                    operator_id, type, origin, target_date, json.dumps(metadata), flagged, threat_level)
