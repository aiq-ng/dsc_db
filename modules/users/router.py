...
async def create_profile(
    ...
    user_id = current_user["current_user"][0]# This would come from current_user in a complete implementation
    return await user_manager.create_profile(user_id, request.full_name, request.bio)